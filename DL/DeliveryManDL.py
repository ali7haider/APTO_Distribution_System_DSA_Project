...
class deliveryManDL:
    ...
    def addDM(s):
        ...
        deliveryManDL.deliveryManCount = deliveryManDL.deliveryManCount + 1
        # else:
        #     salesManDL.salesMan.addToEnd(s)
            
    @staticmethod   
    def addDMToFile(path,s):
        # print(s.password)
    ...
    @staticmethod
    def deleteDeliveryMan(d):
        deliveryManDL.deliveryManLinkedList.remove(d)
        deliveryManDL.deliveryManCount = deliveryManDL.deliveryManCount - 1
    @staticmethod
